            ...
            <div style={{display: "flex", alignItems: "center"}}>
                ...
                <ul style={{
                  ...
                  justifyContent: "space-around",
                      ...
                      <a href="#" className="nav-item" style={{borderBottom: child === "profil" ? "2px solid #aa852b" : "none"}}><li onClick={() => handleNavigate("profil")}>{language === "en" ? "Life is a pitch": "Le Pitch"}</li></a>
