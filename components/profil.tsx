...
const Profil = ({language}) => {
  ...
  if(language === "en"){
    return (
      <div className="global-style-component" style={{paddingTop: windowSize < 480 && "5vh"}}>
          <p className="shadow-level1 small-title">I am not a developer</p>
          <h1 className="shadow-level1 big-title" style={{fontSize: windowSize < 480 && "6.5rem"}}>I am a <br/> Miracle Worker</h1>
    ...
    return (
      <div className="global-style-component" style={{paddingTop: windowSize < 480 && "10vh"}}>
          <p className="shadow-level1 small-title">Je ne suis pas un développeur</p>
          <h1 className="shadow-level1 big-title" style={{fontSize: windowSize < 480 && "5rem"}}>Je suis un  <br/> Faiseur de Miracles</h1>
